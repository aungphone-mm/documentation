...
<calendar/google>` calendars, by heading to
:menuselection:`Calendar app --> Configuration --> Settings`. Events created in synced calendars
automatically appear across the integrated platforms.
...
like :guilabel:`Meeting` or :guilabel:`Call for Demo`, link to the **Calendar** app.
